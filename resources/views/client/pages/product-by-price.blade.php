                                    ...
                                    <ul>
                                        <li>
                                            <input id="PriceIDTag1" type="radio" name="PriceCheck" class="checked "
                                                value="1">
                                            <label for="PriceIDTag1">Dưới 1.000.000VNĐ</label>
                                        </li>
                                        <li>
                                            <input id="PriceIDTag2" type="radio" name="PriceCheck" class="checked "
                                                value="2">
                                            <label for="PriceIDTag2">1.000.000 - 5.000.000VNĐ</label>
                                        </li>
                                        <li>
                                            <input id="PriceIDTag3" type="radio" name="PriceCheck" class="checked "
                                                value="3">
                                            <label for="PriceIDTag3">5.000.000 - 10.000.000VNĐ</label>
                                        </li>
                                        <li>
                                            <input id="PriceIDTag4" type="radio" name="PriceCheck" class="checked "
                                                value="4">
                                            <label for="PriceIDTag4">10.000.000 - 15.000.000VNĐ</label>
                                        </li>
                                        <li>
                                            <input id="PriceIDTag5" type="radio" name="PriceCheck" class="checked "
                                                value="5">
                                            <label for="PriceIDTag5">15.000.000 - 20.000.000VNĐ</label>
                                        </li>
                                        <li>
                                            <input id="PriceIDTag6" type="radio" name="PriceCheck" class="checked "
                                                value="6">
                                            <label for="PriceIDTag6">Trên 20.000.000VNĐ</label>
                                        </li>
